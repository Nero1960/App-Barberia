        ...
        <footer className="bg-dark-500 px-5 md:px-48 pt-10 pb-4">
            <div className="flex flex-col md:flex-row justify-around text-secondary-500 place-items-center space-y-5 md:space-y-0 w-full">
                <div className='md:w-1/3 flex flex-col  justify-center items-center'>
                    ...
                    <div className="text-white flex justify-center space-x-4  md:mt-0">
                        <a href="#"><img src={facebook} alt="facebook red social" width={25} height={25} /></a>
                        <a href="#"><img src={instagram} alt="instagram red social" width={25} height={25} /></a>
                        <a href="#"><img src={tiktok} alt="tiktok red social" width={25} height={25} /></a>
                    </div>
                </div>
