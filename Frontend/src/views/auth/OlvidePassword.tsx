...
function OlvidePassword() {
    ...
    return (
        <>
            ...
            <form action="/olvide-password" method="post" className="md:w-3/4 mx-auto bg-dark-600 p-8 rounded-lg shadow-dark-500 shadow-2xl" noValidate onSubmit={handleSubmit(validarForm)}>
