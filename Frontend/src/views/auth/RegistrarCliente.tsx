            ...
            <form action="/registrar" method="post" className="md:w-3/4 mx-auto bg-dark-500 p-8 rounded-lg shadow-dark-500 shadow-2xl" noValidate onSubmit={handleSubmit(registrarCliente)}>
                ...
                <div className="mb-8">
                    ...
                    <div className='flex items-center border-b-[1px] border-b-secondary-400'>
                        ...
                        <input type="tel" id="telefono" placeholder="Número Telefónico" className="px-4 py-2  bg-transparent outline-none text-secondary-400 w-full placeholder:text-secondary-400"
                            {...register('telefono', {
